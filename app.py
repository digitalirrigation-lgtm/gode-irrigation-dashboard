...
# This part safely reads the secret map keys from Streamlit Cloud dashboard settings!
...
with col1:
    ...
    rainfall_levels = [15, 25, 65, 110, 45, 10, 5, 12, 8, 95, 80, 20]
    colors = ['#e74c3c' if r < 30 else '#f1c40f' if r < 70 else '#2ecc71' for r in rainfall_levels]
